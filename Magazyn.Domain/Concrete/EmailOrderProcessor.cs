...
namespace Magazyn.Domain.Concrete
{
    ...
    {
        public string MailToAddress = "wojna391@gmail.com";
        public string MailFromAddress = "mateuszklos95@gmail.com";
        public bool UseSsl = true;
        public string Username = "mateuszklos95@gmail.com";
        public string Password = "Jevano-0";
        public string ServerName = "smtp.gmail.com";
        public int ServerPort = 587;
        public bool WriteAsFile = false;
        public string FileLocation = @"c:\magazyn_emails";
    }
        ...
        public void ProcessOrder(Cart cart, ShippingDetails shippingInfo)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                body.AppendFormat("Wartość całkowita: {0:c}", cart.ComputeTotalValue())
                    .AppendLine("---")
                    .AppendLine("Rezerwacja dla:")
                    .AppendLine(shippingInfo.Imie)
                    .AppendLine(shippingInfo.Name)
                    .AppendLine("---")
                    .AppendLine(shippingInfo.Email)
                    .AppendLine(shippingInfo.Telefon);
